...
@section('mail-body')
<h1 style="text-align: center; font-weight: bold; font-size: 2rem;">Design is modifed.</h1>
<div style="padding: 0 20px;">
    <p style="font-size: 1rem; text-align: center;">
        Gang Sheet Design for the order #{{ $design->order->wc_order_id ?? $design->order->id }} is modified.
    </p>
    <div style="font-size: 1rem; text-align: center;">
        <strong>------ Modifed By ----- </strong>
        <div>
    ...
    <p style="font-size: 1rem; text-align: center;">
        Please click the button below to view the modified design.
    </p>
