...
export default defineComponent({
    name: 'Transactions',
    components: {Pagination, SvgIcon, MerchantLayout, GbsSelect, Table},
    props: {
        transactions: {
            type: Object,
            required: true
    ...
    watch: {
        filter: {
            ...
            handler() {
                debounce(() => {
                    router.get(this.$route('merchant.transaction.index', {
                    ...
                    <div class="border rounded-lg divide-y divide-gray-200">
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 0">
                                ...
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Order/Design</th>
                                ...
                                <tr v-for="design in transactions.data">
                                    <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800">
                                        <div v-if="design.order_id" class="font-medium bg-gray-100 w-max px-2 rounded-lg">
                                            #{{ design.order_id }}
                                        </div>
                                        <div>{{ design.id }}</div>
                                    </td>
