...
<script>
import RollingGangSheetBuilder from '@/Builder/RollingGangSheet/RollingGangSheetBuilder.vue'
...
export default {
    name: 'RollingGangSheetPage',
    components: {CustomerLoginModal, BuilderLayout, RollingGangSheetBuilder, GangSheetHeader},
    mixins: [fontMixin],
    props: {
        id: {
            type: String,
